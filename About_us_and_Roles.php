...
if(isset($_SESSION["lg"])) //die('');
{
 ...
 echo $_SESSION["lg"]. " <br> ";
		...
		?>
						...
						1px; padding-top: 1px; padding-bottom: 1px"><br>
	&nbsp;&nbsp; Created by Jurijus Pacalovas <a href="https://github.com/pjmidgard/Zaden-AI">https://github.com/pjmidgard/Zaden-AI</a> Zaden AI<br>
	&nbsp;&nbsp; Created by Jurijus Pacalovas <a href="https://github.com/pjmidgard/Web_Technology-Marketing_Project">https://github.com/pjmidgard/Web_Technology-Marketing_Project</a> Website for Zaden AI<br>
						</div>
			<br><br>
<?php
